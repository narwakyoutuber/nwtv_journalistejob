Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'appuie sur ~INPUT_CONTEXT~ pour acceder au ~y~vestiaire~s~.',
  ['wear_citizen'] = 'tenue civil',
  ['wear_work'] = 'tenue Journaliste',

  -- garage
  ['spawner_prompt'] = 'appuie sur ~INPUT_CONTEXT~ pour ouvrir le ~y~garage~s~.',
  ['store_veh'] = 'appuyez sur ~INPUT_CONTEXT~ pour ranger le véhicule',
  ['spawn_veh'] = 'sortir véhicule',
  ['spawnpoint_blocked'] = 'Un vehicule bloque la sortie du garage!',
  ['only_reporter'] = 'vous ne pouvez ranger que les Vehicule de service',

  ['taking_service'] = 'prise de service : Journaliste',
  ['full_service'] = 'service complet : ',
  ['amount_invalid'] = 'montant invalide',
  ['press_to_open'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder au menu',
  ['billing'] = 'facturation',
  ['billing_sent'] = 'la facture est enregistré!',
  ['invoice_amount'] = 'montant de la facture',
  ['no_players_near'] = 'aucun joueur à proximité',
  ['start_job'] = 'Commencer / terminer les courses Natifs',
  ...
  ['must_in_reporter'] = 'vous devez être dans un vehicule de journaliste pour commencer la mission',
  ...
  ['reporter_client'] = 'client Journaliste',
  ...
  ['blip_reporter'] = 'Mirror News',
  ['phone_reporter'] = 'reporter',
}